...
VULKAN_HPP_INLINE void swap( UniqueHandle<Type, Dispatch> & lhs, UniqueHandle<Type, Dispatch> & rhs ) VULKAN_HPP_NOEXCEPT
{
  ...
  //=== VK_INTEL_TEST_FRAMEWORK_SUPPORT ===
    ...
    void vkTestFrameworkDispatcherINTEL( VkDevice device, vkTestFrameworkDispatcherConfigurationINTEL * testFrameworkDispatcherConfiguration ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkTestFrameworkDispatcherINTEL( device, testFrameworkDispatcherConfiguration );
    }
  ...
  //=== VK_KHR_dynamic_rendering_local_read ===
    ...
    void vkCmdSetRenderingAttachmentLocationsKHR( VkCommandBuffer commandBuffer, const VkRenderingAttachmentLocationInfoKHR * pLocationInfo ) const VULKAN_HPP_NOEXCEPT
    {
      return ::vkCmdSetRenderingAttachmentLocationsKHR( commandBuffer, pLocationInfo );
    }


    void vkCmdSetRenderingInputAttachmentIndicesKHR( VkCommandBuffer commandBuffer, const VkRenderingInputAttachmentIndexInfoKHR * pInputAttachmentIndexInfo ) const VULKAN_HPP_NOEXCEPT
    {
...
VULKAN_HPP_CONSTEXPR_INLINE auto INTELShaderIntegerFunctions2SpecVersion = VK_INTEL_SHADER_INTEGER_FUNCTIONS_2_SPEC_VERSION;
  ...
  //=== VK_INTEL_TEST_FRAMEWORK_SUPPORT ===
VULKAN_HPP_CONSTEXPR_INLINE auto INTELTestFrameworkSupportExtensionName = VK_INTEL_TEST_FRAMEWORK_SUPPORT_EXTENSION_NAME;
VULKAN_HPP_CONSTEXPR_INLINE auto INTELTestFrameworkSupportSpecVersion = VK_INTEL_TEST_FRAMEWORK_SUPPORT_SPEC_VERSION;
...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  template <> struct StructExtends<PipelineLayoutCreateInfo, BindDescriptorSetsInfoKHR>{ enum { value = true }; };
  template <> struct StructExtends<PipelineLayoutCreateInfo, PushConstantsInfoKHR>{ enum { value = true }; };
  template <> struct StructExtends<PipelineLayoutCreateInfo, PushDescriptorSetInfoKHR>{ enum { value = true }; };
  template <> struct StructExtends<PipelineLayoutCreateInfo, PushDescriptorSetWithTemplateInfoKHR>{ enum { value = true }; };
  ...
  //=== VK_KHR_dynamic_rendering_local_read ===
  template <> struct StructExtends<PhysicalDeviceDynamicRenderingLocalReadFeaturesKHR, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceDynamicRenderingLocalReadFeaturesKHR, DeviceCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<RenderingAttachmentLocationInfoKHR, GraphicsPipelineCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<RenderingAttachmentLocationInfoKHR, CommandBufferInheritanceInfo>{ enum { value = true }; };
  template <> struct StructExtends<RenderingInputAttachmentIndexInfoKHR, GraphicsPipelineCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<RenderingInputAttachmentIndexInfoKHR, CommandBufferInheritanceInfo>{ enum { value = true }; };
  ...
  //=== VK_EXT_host_image_copy ===
  template <> struct StructExtends<PhysicalDeviceHostImageCopyFeaturesEXT, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceHostImageCopyFeaturesEXT, DeviceCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceHostImageCopyPropertiesEXT, PhysicalDeviceProperties2>{ enum { value = true }; };
  template <> struct StructExtends<SubresourceHostMemcpySizeEXT, SubresourceLayout2KHR>{ enum { value = true }; };
  template <> struct StructExtends<HostImageCopyDevicePerformanceQueryEXT, ImageFormatProperties2>{ enum { value = true }; };
  ...
  template <> struct StructExtends<MemoryMapPlacedInfoEXT, MemoryMapInfoKHR>{ enum { value = true }; };
  ...
  template <> struct StructExtends<ImageCompressionPropertiesEXT, SubresourceLayout2KHR>{ enum { value = true }; };
  ...
  //=== VK_KHR_shader_subgroup_rotate ===
  template <> struct StructExtends<PhysicalDeviceShaderSubgroupRotateFeaturesKHR, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceShaderSubgroupRotateFeaturesKHR, DeviceCreateInfo>{ enum { value = true }; };
  ...
  //=== VK_KHR_maintenance5 ===
  template <> struct StructExtends<PhysicalDeviceMaintenance5FeaturesKHR, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceMaintenance5FeaturesKHR, DeviceCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceMaintenance5PropertiesKHR, PhysicalDeviceProperties2>{ enum { value = true }; };
  template <> struct StructExtends<PipelineCreateFlags2CreateInfoKHR, ComputePipelineCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<PipelineCreateFlags2CreateInfoKHR, GraphicsPipelineCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<PipelineCreateFlags2CreateInfoKHR, RayTracingPipelineCreateInfoNV>{ enum { value = true }; };
  template <> struct StructExtends<PipelineCreateFlags2CreateInfoKHR, RayTracingPipelineCreateInfoKHR>{ enum { value = true }; };
  template <> struct StructExtends<BufferUsageFlags2CreateInfoKHR, BufferViewCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<BufferUsageFlags2CreateInfoKHR, BufferCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<BufferUsageFlags2CreateInfoKHR, PhysicalDeviceExternalBufferInfo>{ enum { value = true }; };
  template <> struct StructExtends<BufferUsageFlags2CreateInfoKHR, DescriptorBufferBindingInfoEXT>{ enum { value = true }; };
  ...
  //=== VK_KHR_vertex_attribute_divisor ===
  template <> struct StructExtends<PhysicalDeviceVertexAttributeDivisorPropertiesKHR, PhysicalDeviceProperties2>{ enum { value = true }; };
  template <> struct StructExtends<PipelineVertexInputDivisorStateCreateInfoKHR, PipelineVertexInputStateCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceVertexAttributeDivisorFeaturesKHR, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceVertexAttributeDivisorFeaturesKHR, DeviceCreateInfo>{ enum { value = true }; };

  //=== VK_KHR_shader_float_controls2 ===
  template <> struct StructExtends<PhysicalDeviceShaderFloatControls2FeaturesKHR, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceShaderFloatControls2FeaturesKHR, DeviceCreateInfo>{ enum { value = true }; };
  ...
  //=== VK_KHR_index_type_uint8 ===
  template <> struct StructExtends<PhysicalDeviceIndexTypeUint8FeaturesKHR, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceIndexTypeUint8FeaturesKHR, DeviceCreateInfo>{ enum { value = true }; };

  //=== VK_KHR_line_rasterization ===
  template <> struct StructExtends<PhysicalDeviceLineRasterizationFeaturesKHR, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceLineRasterizationFeaturesKHR, DeviceCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceLineRasterizationPropertiesKHR, PhysicalDeviceProperties2>{ enum { value = true }; };
  template <> struct StructExtends<PipelineRasterizationLineStateCreateInfoKHR, PipelineRasterizationStateCreateInfo>{ enum { value = true }; };

  //=== VK_KHR_shader_expect_assume ===
  template <> struct StructExtends<PhysicalDeviceShaderExpectAssumeFeaturesKHR, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceShaderExpectAssumeFeaturesKHR, DeviceCreateInfo>{ enum { value = true }; };

  //=== VK_KHR_maintenance6 ===
  template <> struct StructExtends<PhysicalDeviceMaintenance6FeaturesKHR, PhysicalDeviceFeatures2>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceMaintenance6FeaturesKHR, DeviceCreateInfo>{ enum { value = true }; };
  template <> struct StructExtends<PhysicalDeviceMaintenance6PropertiesKHR, PhysicalDeviceProperties2>{ enum { value = true }; };
  template <> struct StructExtends<BindMemoryStatusKHR, BindBufferMemoryInfo>{ enum { value = true }; };
  template <> struct StructExtends<BindMemoryStatusKHR, BindImageMemoryInfo>{ enum { value = true }; };
...
#  endif
  ...
  //=== VK_INTEL_TEST_FRAMEWORK_SUPPORT ===
    PFN_vkTestFrameworkDispatcherINTEL vkTestFrameworkDispatcherINTEL = 0;
  ...
  //=== VK_INTEL_TEST_FRAMEWORK_SUPPORT ===
      vkTestFrameworkDispatcherINTEL = PFN_vkTestFrameworkDispatcherINTEL( vkGetInstanceProcAddr( instance, "vkTestFrameworkDispatcherINTEL" ) );
  ...
  //=== VK_EXT_line_rasterization ===
      ...
      if ( !vkCmdSetLineStippleKHR ) vkCmdSetLineStippleKHR = vkCmdSetLineStippleEXT;
  ...
  //=== VK_EXT_host_image_copy ===
      ...
      if ( !vkGetImageSubresourceLayout2KHR ) vkGetImageSubresourceLayout2KHR = vkGetImageSubresourceLayout2EXT;
  ...
  //=== VK_INTEL_TEST_FRAMEWORK_SUPPORT ===
      vkTestFrameworkDispatcherINTEL = PFN_vkTestFrameworkDispatcherINTEL( vkGetDeviceProcAddr( device, "vkTestFrameworkDispatcherINTEL" ) );
