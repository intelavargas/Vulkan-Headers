...
#if defined( VK_USE_PLATFORM_SCI )
        | ExternalFenceHandleTypeFlagBits::eSciSyncObjNV
        | ExternalFenceHandleTypeFlagBits::eSciSyncFenceNV
#endif /*VK_USE_PLATFORM_SCI*/
;
  };
...
;
  ...
  template <> struct FlagTraits<RefreshObjectFlagBitsKHR>
  {
    static VULKAN_HPP_CONST_OR_CONSTEXPR bool isBitmask = true;
