...
namespace VULKAN_HPP_NAMESPACE
{
  ...
  VULKAN_HPP_INLINE std::string to_string( ImageUsageFlags value )
  {
    ...
    if ( value & ImageUsageFlagBits::eHostTransferEXT ) result += "HostTransferEXT | ";
  ...
  VULKAN_HPP_INLINE std::string to_string( SubgroupFeatureFlags value )
  {
    ...
    if ( value & SubgroupFeatureFlagBits::eRotateKHR ) result += "RotateKHR | ";
    if ( value & SubgroupFeatureFlagBits::eRotateClusteredKHR ) result += "RotateClusteredKHR | ";
  ...
  VULKAN_HPP_INLINE std::string to_string( FormatFeatureFlags2 value )
  {
    ...
    if ( value & FormatFeatureFlagBits2::eHostImageTransferEXT ) result += "HostImageTransferEXT | ";
  ...
  VULKAN_HPP_INLINE std::string to_string( HostImageCopyFlagsEXT value )
  {
    ...
    std::string result;
    if ( value & HostImageCopyFlagBitsEXT::eMemcpy ) result += "Memcpy | ";
  ...
  VULKAN_HPP_INLINE std::string to_string( MemoryUnmapFlagsKHR value )
  {
    ...
    std::string result;
    if ( value & MemoryUnmapFlagBitsKHR::eReserveEXT ) result += "ReserveEXT | ";
  ...
  VULKAN_HPP_INLINE std::string to_string( PipelineCreateFlags2KHR value )
  {
    ...
    std::string result;
    if ( value & PipelineCreateFlagBits2KHR::eDisableOptimization ) result += "DisableOptimization | ";
    if ( value & PipelineCreateFlagBits2KHR::eAllowDerivatives ) result += "AllowDerivatives | ";
    if ( value & PipelineCreateFlagBits2KHR::eDerivative ) result += "Derivative | ";
    if ( value & PipelineCreateFlagBits2KHR::eEnableLegacyDitheringEXT ) result += "EnableLegacyDitheringEXT | ";
    if ( value & PipelineCreateFlagBits2KHR::eViewIndexFromDeviceIndex ) result += "ViewIndexFromDeviceIndex | ";
    if ( value & PipelineCreateFlagBits2KHR::eDispatchBase ) result += "DispatchBase | ";
    if ( value & PipelineCreateFlagBits2KHR::eDeferCompileNV ) result += "DeferCompileNV | ";
    if ( value & PipelineCreateFlagBits2KHR::eCaptureStatistics ) result += "CaptureStatistics | ";
    if ( value & PipelineCreateFlagBits2KHR::eCaptureInternalRepresentations ) result += "CaptureInternalRepresentations | ";
    if ( value & PipelineCreateFlagBits2KHR::eFailOnPipelineCompileRequired ) result += "FailOnPipelineCompileRequired | ";
    if ( value & PipelineCreateFlagBits2KHR::eEarlyReturnOnFailure ) result += "EarlyReturnOnFailure | ";
    if ( value & PipelineCreateFlagBits2KHR::eLinkTimeOptimizationEXT ) result += "LinkTimeOptimizationEXT | ";
    if ( value & PipelineCreateFlagBits2KHR::eRetainLinkTimeOptimizationInfoEXT ) result += "RetainLinkTimeOptimizationInfoEXT | ";
    if ( value & PipelineCreateFlagBits2KHR::eLibrary ) result += "Library | ";
    if ( value & PipelineCreateFlagBits2KHR::eRayTracingSkipTriangles ) result += "RayTracingSkipTriangles | ";
    if ( value & PipelineCreateFlagBits2KHR::eRayTracingSkipAabbs ) result += "RayTracingSkipAabbs | ";
    if ( value & PipelineCreateFlagBits2KHR::eRayTracingNoNullAnyHitShaders ) result += "RayTracingNoNullAnyHitShaders | ";
    if ( value & PipelineCreateFlagBits2KHR::eRayTracingNoNullClosestHitShaders ) result += "RayTracingNoNullClosestHitShaders | ";
    if ( value & PipelineCreateFlagBits2KHR::eRayTracingNoNullMissShaders ) result += "RayTracingNoNullMissShaders | ";
    if ( value & PipelineCreateFlagBits2KHR::eRayTracingNoNullIntersectionShaders ) result += "RayTracingNoNullIntersectionShaders | ";
    if ( value & PipelineCreateFlagBits2KHR::eRayTracingShaderGroupHandleCaptureReplay ) result += "RayTracingShaderGroupHandleCaptureReplay | ";
    if ( value & PipelineCreateFlagBits2KHR::eIndirectBindableNV ) result += "IndirectBindableNV | ";
    if ( value & PipelineCreateFlagBits2KHR::eRayTracingAllowMotionNV ) result += "RayTracingAllowMotionNV | ";
    if ( value & PipelineCreateFlagBits2KHR::eRenderingFragmentShadingRateAttachment ) result += "RenderingFragmentShadingRateAttachment | ";
    if ( value & PipelineCreateFlagBits2KHR::eRenderingFragmentDensityMapAttachmentEXT ) result += "RenderingFragmentDensityMapAttachmentEXT | ";
    if ( value & PipelineCreateFlagBits2KHR::eRayTracingOpacityMicromapEXT ) result += "RayTracingOpacityMicromapEXT | ";
    if ( value & PipelineCreateFlagBits2KHR::eColorAttachmentFeedbackLoopEXT ) result += "ColorAttachmentFeedbackLoopEXT | ";
    if ( value & PipelineCreateFlagBits2KHR::eDepthStencilAttachmentFeedbackLoopEXT ) result += "DepthStencilAttachmentFeedbackLoopEXT | ";
    if ( value & PipelineCreateFlagBits2KHR::eNoProtectedAccessEXT ) result += "NoProtectedAccessEXT | ";
    if ( value & PipelineCreateFlagBits2KHR::eProtectedAccessOnlyEXT ) result += "ProtectedAccessOnlyEXT | ";
    if ( value & PipelineCreateFlagBits2KHR::eRayTracingDisplacementMicromapNV ) result += "RayTracingDisplacementMicromapNV | ";
    if ( value & PipelineCreateFlagBits2KHR::eDescriptorBufferEXT ) result += "DescriptorBufferEXT | ";
    if ( value & PipelineCreateFlagBits2KHR::eCaptureData ) result += "CaptureData | ";
    if ( value & PipelineCreateFlagBits2KHR::eIndirectBindableEXT ) result += "IndirectBindableEXT | ";
  ...
  VULKAN_HPP_INLINE std::string to_string( BufferUsageFlags2KHR value )
  {
    ...
    std::string result;
    if ( value & BufferUsageFlagBits2KHR::eTransferSrc ) result += "TransferSrc | ";
    if ( value & BufferUsageFlagBits2KHR::eTransferDst ) result += "TransferDst | ";
    if ( value & BufferUsageFlagBits2KHR::eUniformTexelBuffer ) result += "UniformTexelBuffer | ";
    if ( value & BufferUsageFlagBits2KHR::eStorageTexelBuffer ) result += "StorageTexelBuffer | ";
    if ( value & BufferUsageFlagBits2KHR::eUniformBuffer ) result += "UniformBuffer | ";
    if ( value & BufferUsageFlagBits2KHR::eStorageBuffer ) result += "StorageBuffer | ";
    if ( value & BufferUsageFlagBits2KHR::eIndexBuffer ) result += "IndexBuffer | ";
    if ( value & BufferUsageFlagBits2KHR::eVertexBuffer ) result += "VertexBuffer | ";
    if ( value & BufferUsageFlagBits2KHR::eIndirectBuffer ) result += "IndirectBuffer | ";
#if defined( VK_ENABLE_BETA_EXTENSIONS )
    if ( value & BufferUsageFlagBits2KHR::eExecutionGraphScratchAMDX ) result += "ExecutionGraphScratchAMDX | ";
#endif /*VK_ENABLE_BETA_EXTENSIONS*/
    if ( value & BufferUsageFlagBits2KHR::eConditionalRenderingEXT ) result += "ConditionalRenderingEXT | ";
    if ( value & BufferUsageFlagBits2KHR::eShaderBindingTable ) result += "ShaderBindingTable | ";
    if ( value & BufferUsageFlagBits2KHR::eTransformFeedbackBufferEXT ) result += "TransformFeedbackBufferEXT | ";
    if ( value & BufferUsageFlagBits2KHR::eTransformFeedbackCounterBufferEXT ) result += "TransformFeedbackCounterBufferEXT | ";
    if ( value & BufferUsageFlagBits2KHR::eVideoDecodeSrc ) result += "VideoDecodeSrc | ";
    if ( value & BufferUsageFlagBits2KHR::eVideoDecodeDst ) result += "VideoDecodeDst | ";
    if ( value & BufferUsageFlagBits2KHR::eVideoEncodeDst ) result += "VideoEncodeDst | ";
    if ( value & BufferUsageFlagBits2KHR::eVideoEncodeSrc ) result += "VideoEncodeSrc | ";
    if ( value & BufferUsageFlagBits2KHR::eShaderDeviceAddress ) result += "ShaderDeviceAddress | ";
    if ( value & BufferUsageFlagBits2KHR::eAccelerationStructureBuildInputReadOnly ) result += "AccelerationStructureBuildInputReadOnly | ";
    if ( value & BufferUsageFlagBits2KHR::eAccelerationStructureStorage ) result += "AccelerationStructureStorage | ";
    if ( value & BufferUsageFlagBits2KHR::eSamplerDescriptorBufferEXT ) result += "SamplerDescriptorBufferEXT | ";
    if ( value & BufferUsageFlagBits2KHR::eResourceDescriptorBufferEXT ) result += "ResourceDescriptorBufferEXT | ";
    if ( value & BufferUsageFlagBits2KHR::ePushDescriptorsDescriptorBufferEXT ) result += "PushDescriptorsDescriptorBufferEXT | ";
    if ( value & BufferUsageFlagBits2KHR::eMicromapBuildInputReadOnlyEXT ) result += "MicromapBuildInputReadOnlyEXT | ";
    if ( value & BufferUsageFlagBits2KHR::eMicromapStorageEXT ) result += "MicromapStorageEXT | ";
    if ( value & BufferUsageFlagBits2KHR::ePreprocessBufferEXT ) result += "PreprocessBufferEXT | ";
