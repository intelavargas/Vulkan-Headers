...
template <> struct hash<VULKAN_HPP_NAMESPACE::FenceGetWin32HandleInfoKHR>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::HostImageCopyDevicePerformanceQueryEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::HostImageCopyDevicePerformanceQueryEXT const & hostImageCopyDevicePerformanceQueryEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::HostImageLayoutTransitionInfoEXT>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceDisplacementMicromapPropertiesNV>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceDynamicRenderingLocalReadFeaturesKHR>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceExternalMemoryScreenBufferFeaturesQNX>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceHostImageCopyFeaturesEXT>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceHostImageCopyPropertiesEXT>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceHostImageCopyPropertiesEXT const & physicalDeviceHostImageCopyPropertiesEXT) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceIndexTypeUint8FeaturesKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceLineRasterizationFeaturesKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceLineRasterizationPropertiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceLineRasterizationPropertiesKHR const & physicalDeviceLineRasterizationPropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance5FeaturesKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance5PropertiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance5PropertiesKHR const & physicalDeviceMaintenance5PropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance6FeaturesKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance6PropertiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceMaintenance6PropertiesKHR const & physicalDeviceMaintenance6PropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderEnqueuePropertiesAMDX>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderExpectAssumeFeaturesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderExpectAssumeFeaturesKHR const & physicalDeviceShaderExpectAssumeFeaturesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderFloatControls2FeaturesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderFloatControls2FeaturesKHR const & physicalDeviceShaderFloatControls2FeaturesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderSubgroupRotateFeaturesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceShaderSubgroupRotateFeaturesKHR const & physicalDeviceShaderSubgroupRotateFeaturesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceVertexAttributeDivisorFeaturesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceVertexAttributeDivisorFeaturesKHR const & physicalDeviceVertexAttributeDivisorFeaturesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PhysicalDeviceVertexAttributeDivisorPropertiesKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PhysicalDeviceVertexAttributeDivisorPropertiesKHR const & physicalDeviceVertexAttributeDivisorPropertiesKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineCreateFlags2CreateInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineRasterizationLineStateCreateInfoKHR>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineShaderStageNodeCreateInfoAMDX>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::VertexInputBindingDivisorDescriptionKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PipelineVertexInputDivisorStateCreateInfoKHR>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::PipelineVertexInputDivisorStateCreateInfoKHR const & pipelineVertexInputDivisorStateCreateInfoKHR) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
...
template <> struct hash<VULKAN_HPP_NAMESPACE::PresentFrameTokenGGP>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::PushDescriptorSetWithTemplateInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::RenderingAttachmentLocationInfoKHR>
  {
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::RenderingInputAttachmentIndexInfoKHR>
  {
...
template <> struct hash<VULKAN_HPP_NAMESPACE::XlibSurfaceCreateInfoKHR>
  ...
  template <> struct hash<VULKAN_HPP_NAMESPACE::vkTestFrameworkDispatcherConfigurationINTEL>
  {
    std::size_t operator()(VULKAN_HPP_NAMESPACE::vkTestFrameworkDispatcherConfigurationINTEL const & vkTestFrameworkDispatcherConfigurationINTEL) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
    for ( const char* p = vkTestFrameworkDispatcherConfigurationINTEL.functionName; *p != '\0'; ++p )
    {
      VULKAN_HPP_HASH_COMBINE( seed, *p );
    }
      return seed;
